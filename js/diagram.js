...
const EvolvingDiagram = {
  ...
  render(containerId, visibleLayers) {
    ...
    const layerFill    = (key) => this.state.layers[key] ? 'rgba(161,0,255,0.08)' : 'transparent';
    ...
    <svg viewBox="0 0 700 400" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:700px;">
      ...
      <g style="opacity:${layerOpacity('tools')};transition:opacity 0.8s ease;filter:${glowFilter('tools')}">
        ...
        <g style="opacity:${layerOpacity('tools')};transition:opacity 0.6s ease 0.2s">
          <rect x="130" y="165" width="90" height="32" rx="3" fill="rgba(161,0,255,0.06)" stroke="var(--stroke-dim)" stroke-width="1"/>
          <text x="175" y="185" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="8">data_access</text>
        </g>
        <g style="opacity:${layerOpacity('tools')};transition:opacity 0.6s ease 0.3s">
          <rect x="230" y="165" width="90" height="32" rx="3" fill="rgba(161,0,255,0.06)" stroke="var(--stroke-dim)" stroke-width="1"/>
          <text x="275" y="185" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="8">transform</text>
        </g>
        <g style="opacity:${layerOpacity('tools')};transition:opacity 0.6s ease 0.4s">
          <rect x="330" y="165" width="90" height="32" rx="3" fill="rgba(161,0,255,0.06)" stroke="var(--stroke-dim)" stroke-width="1"/>
          <text x="375" y="185" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="8">external_api</text>
        </g>
        <g style="opacity:${layerOpacity('tools')};transition:opacity 0.6s ease 0.5s">
          <rect x="430" y="165" width="90" height="32" rx="3" fill="rgba(161,0,255,0.06)" stroke="var(--stroke-dim)" stroke-width="1"/>
          <text x="475" y="185" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="8">compute</text>
        </g>
      </g>
      <g style="opacity:${layerOpacity('runtime')};transition:opacity 0.8s ease;filter:${glowFilter('runtime')}">
        <rect x="160" y="210" width="380" height="100" rx="4" fill="rgba(161,0,255,0.1)" stroke="${layerStroke('runtime')}" stroke-width="2"/>
        ...
        <rect x="180" y="245" width="70" height="28" rx="3" fill="rgba(161,0,255,0.08)" stroke="var(--stroke-dim)" stroke-width="1"/>
        <text x="215" y="263" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="8">LLM</text>
        <rect x="260" y="245" width="85" height="28" rx="3" fill="rgba(161,0,255,0.08)" stroke="var(--stroke-dim)" stroke-width="1"/>
        <text x="302" y="263" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="8">State Mgr</text>
        <rect x="355" y="245" width="75" height="28" rx="3" fill="rgba(161,0,255,0.08)" stroke="var(--stroke-dim)" stroke-width="1"/>
        <text x="392" y="263" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="8">Memory</text>
        <rect x="440" y="245" width="80" height="28" rx="3" fill="rgba(161,0,255,0.08)" stroke="var(--stroke-dim)" stroke-width="1"/>
        <text x="480" y="263" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="8">Orchestrator</text>
      ...
      <g stroke="var(--stroke-dim)" stroke-width="0.5" opacity="0.4">
        ...
        <text x="10" y="215" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="7" text-anchor="middle" transform="rotate(-90,10,215)">FULL STACK</text>
      </g>
    </svg>`;
  ...
  renderAgentAnatomy(containerId) {
    ...
    <svg viewBox="0 0 700 420" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:700px;">
      ...
      <text x="350" y="200" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="13" font-weight="700">LLM</text>
      <text x="350" y="218" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="9">Core Reasoning Engine</text>
      ...
      <text x="350" y="90" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">LangGraph orchestration · workflow state</text>
      ...
      <text x="597" y="119" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">short-term · long-term · episodic</text>
      ...
      <text x="607" y="223" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">SQL · API · compute · data access</text>
      ...
      <text x="350" y="349" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">guardrails · RBAC · PII masking · limits</text>
      ...
      <text x="102" y="119" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">RAG · schema · business rules</text>
      ...
      <text x="92" y="223" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">active prompt · history · instructions</text>
  ...
  renderRoleTaxonomy(containerId) {
    ...
    <svg viewBox="0 0 700 400" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:700px;">
      ...
      <text x="350" y="75" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="13" font-weight="700">Orchestrator</text>
      <text x="350" y="93" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="9">Decomposes goals · delegates sub-tasks</text>
      ...
      <!-- Delegate labels -->
      <text x="218" y="168" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">delegates</text>
      <text x="482" y="168" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">delegates</text>
      ...
      <text x="185" y="242" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="9">Cross-domain generalist</text>
      <text x="185" y="257" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">ambiguous requests · broad reasoning</text>
      <text x="185" y="271" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">multi-domain knowledge · flexible scope</text>
      ...
      <text x="515" y="242" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="9">Single-purpose specialist</text>
      <text x="515" y="257" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">scoped permissions · targeted guardrails</text>
      <text x="515" y="271" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">fast · reliable · one task done well</text>

      <!-- Example boxes -->
      <rect x="70" y="310" width="230" height="36" rx="4" fill="rgba(204,0,255,0.05)" stroke="#CC00FF" stroke-width="1" stroke-dasharray="4,2"/>
      <text x="185" y="325" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">e.g. "Generate a full sales report</text>
      <text x="185" y="338" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">with insights across all regions"</text>

      <rect x="400" y="310" width="230" height="36" rx="4" fill="rgba(245,158,11,0.05)" stroke="#f59e0b" stroke-width="1" stroke-dasharray="4,2"/>
      <text x="515" y="325" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">e.g. "Run this SQL query and</text>
      <text x="515" y="338" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">return the result set"</text>
  ...
  renderLangGraphPatterns(containerId) {
    ...
    <svg viewBox="0 0 700 400" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:700px;">
      ...
      <text x="350" y="74" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">{ query, intent, sql, result,</text>
      <text x="350" y="88" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">  errors, retry_count, output }</text>
      ...
      <text x="350" y="162" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="10">parse_intent</text>
      ...
      <text x="235" y="220" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">data query</text>
      <rect x="60" y="210" width="100" height="36" rx="4" fill="rgba(161,0,255,0.08)" stroke="#A100FF" stroke-width="1.5"/>
      <text x="110" y="232" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="9">generate_sql</text>
      ...
      <text x="460" y="220" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">report gen</text>
      ...
      <rect x="360" y="355" width="140" height="36" rx="4" fill="rgba(161,0,255,0.1)" stroke="#A100FF" stroke-width="2"/>
      <text x="430" y="377" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="10">format_output</text>
  ...
  renderReactLoop(containerId) {
    ...
    <svg viewBox="0 0 700 400" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:700px;">
      ...
      <text x="350" y="63" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="9">User Query</text>
      ...
      <text x="350" y="152" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="9">Reason about what action is needed</text>
      <text x="350" y="168" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">"I need to discover schema before writing SQL"</text>
      ...
      <text x="620" y="152" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="9">Call tool</text>
      <text x="620" y="168" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">emit JSON</text>
      ...
      <text x="620" y="302" text-anchor="middle" fill="#c4a8d8" font-family="JetBrains Mono, monospace" font-size="9">Examine result</text>
      <text x="620" y="318" text-anchor="middle" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="8">update state</text>
      ...
      <text x="350" y="284" text-anchor="middle" fill="#f5f5f5" font-family="JetBrains Mono, monospace" font-size="8">done?</text>
      ...
      <text x="30" y="150" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="7.5">① THINK: discover schema</text>
      <text x="30" y="167" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="7.5">① ACT: get_schema(sales)</text>
      <text x="30" y="184" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="7.5">① OBSERVE: 9 cols found</text>
      <text x="30" y="207" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="7.5">② THINK: write SQL query</text>
      <text x="30" y="224" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="7.5">② ACT: validate_sql(...)</text>
      <text x="30" y="241" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="7.5">② OBSERVE: valid ✓</text>
      <text x="30" y="264" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="7.5">③ THINK: execute query</text>
      <text x="30" y="281" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="7.5">③ ACT: run_query(sql)</text>
      <text x="30" y="298" fill="#a08ab8" font-family="JetBrains Mono, monospace" font-size="7.5">③ OBSERVE: 847 rows</text>
